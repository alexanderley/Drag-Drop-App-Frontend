...
import AddNewBoardForm from "../Ui/forms/AddNewBoardForm";
...
export default function BoardSelection() {
  ...
  const addBoardClickHandler = () => {
    console.log("Open the Board Modal");
    setAddNewBoardFormIsVisible(true);
  };
      ...
      >
        <div className="topSection">
          ...
          <div className="createNewBoardContainer boardTab">
            ...
            <span onClick={addBoardClickHandler}>+ Create a new Board</span>
          </div>
        </div>
        <div className="bottomSection">
          ...
          <div className="hideSidebar" onClick={hideClickHandler}>
            ...
            <button
              className={`makeVisibleButton ${
                !sideBarIsVisible ? "makeVisibleVisilbe" : "makeVisibileHidden"
              }`}
            >
